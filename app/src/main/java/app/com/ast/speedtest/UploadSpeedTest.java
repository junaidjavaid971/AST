...
/**
 * Created by Zohaib on 12/4/2019.
 */
public class UploadSpeedTest extends Thread {
    ...
    public UploadSpeedTest(String fileURL) {
    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                ...
                UploadSpeedTest.uploadedKByte += buffer.length / 1024.0;
